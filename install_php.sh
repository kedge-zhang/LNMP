...
configure5="./configure --prefix=$home_path/$version --with-config-file-path=$home_path/$version/etc --enable-inline-optimization  --disable-debug --disable-rpath --enable-shared --enable-opcache --enable-fpm --with-fpm-user=www --with-fpm-group=www --with-pdo-mysql=mysqlnd --with-pdo-sqlite --with-mysqli=mysqlnd --with-gettext -enable-mbstring --with-iconv-dir --with-mhash --with-openssl --with-jpeg-dir --with-png-dir --with-freetype-dir --with-libxml-dir --with-xmlrpc --with-gd --with-libxml-dir --with-curl --with-zlib --with-bz2 --with-pear --with-pcre-dir --with-mcrypt --enable-mbregex --enable-mbstring --enable-bcmath --enable-soap --enable-pcntl --enable-shmop --enable-sysvmsg --enable-sysvsem --enable-sysvshm --enable-sockets  --enable-xml --enable-zip  --enable-ftp --with-readline --enable-mysqlnd-compression-support"
configure7="./configure --prefix=$home_path/$version --with-config-file-path=$home_path/$version/etc --enable-inline-optimization  --disable-debug --disable-rpath --enable-shared --enable-opcache --enable-fpm --with-fpm-user=www --with-fpm-group=www --with-pdo-mysql=mysqlnd --with-pdo-sqlite --with-mysqli=mysqlnd --with-gettext -enable-mbstring --with-iconv-dir --with-mhash --with-openssl --with-jpeg-dir --with-png-dir --with-freetype-dir --with-libxml-dir --with-xmlrpc --with-gd --with-libxml-dir --with-curl --with-zlib --with-bz2 --with-pear --with-pcre-dir  --enable-mbregex --enable-mbstring --enable-bcmath --enable-soap --enable-pcntl --enable-shmop --enable-sysvmsg --enable-sysvsem --enable-sysvshm --enable-sockets  --enable-xml --enable-zip  --enable-ftp --with-readline --enable-mysqlnd-compression-support"
