...
```
##解决依赖
yum install gcc gcc-c++ autoconf libxml2 libxml2-devel curl  curl-devel libwebp.x86_64  libwebp-devel.x86_64 libwebp-tools.x86_64 libjpeg libjpeg-devel libpng libpng-devel freetype freetype-devel libxslt  libxslt-devel -y net-snmp net-snmp-devel bzip2-devel libmcrypt libmcrypt-devel readline readline-devel
##获取PHP
